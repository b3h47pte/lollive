...
private:
  DECLARE_CONFIG_VARIABLE(ChampImgSplitDimX, int, ConfigManager::CONFIG_LEAGUE_FILENAME, "ImageAnalyzer", 0.0)
  DECLARE_CONFIG_VARIABLE(ChampImgSplitDimY, int, ConfigManager::CONFIG_LEAGUE_FILENAME, "ImageAnalyzer", 0.0)
  DECLARE_CONFIG_VARIABLE(ChampImgHBuckets, int, ConfigManager::CONFIG_LEAGUE_FILENAME, "ImageAnalyzer", 0.0)
  DECLARE_CONFIG_VARIABLE(ChampImgSBuckets, int, ConfigManager::CONFIG_LEAGUE_FILENAME, "ImageAnalyzer", 0.0)
  DECLARE_CONFIG_VARIABLE(ChampImgVBuckets, int, ConfigManager::CONFIG_LEAGUE_FILENAME, "ImageAnalyzer", 0.0)
